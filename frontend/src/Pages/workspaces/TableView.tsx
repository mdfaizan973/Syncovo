        ...
        <div className="flex items-start gap-3 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
                ...
                <p
                    ...
                    className="mt-1 text-sm text-gray-500 leading-5 overflow-hidden break-words"
                    style={{
                        display: "-webkit-box",
                        WebkitLineClamp: 2,
        ...
        <div className="flex items-center gap-2 flex-wrap lg:justify-end shrink-0">
            ...
            <div className="relative">
                ...
                <Input
                    ...
                    leftIcon={
                        <Search className="w-3.5 h-3.5 text-gray-400 pointer-events-none" />
                    }
                />
            </div>
            ...
            <button
                ...
                className={`h-9 px-3 cursor-pointer text-sm font-medium rounded-lg border transition-all flex items-center gap-1.5 ${
                    filterOpen
            ...
            {isNonViewer(table?.viewers) && (
                <>
                    ...
                    <button
                        ...
                        className="w-10 h-10 cursor-pointer rounded-lg border border-red-100 bg-red-50 text-red-500 flex items-center justify-center hover:bg-red-100 transition-all"
                    >
