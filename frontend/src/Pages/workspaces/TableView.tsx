                    ...
                    <div className="bg-white rounded-xl border border-gray-100 px-4 py-3">
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        leftIcon={<SearchIcon className="w-3.5 h-3.5 text-gray-400 pointer-events-none" />}
                                    />
                                </div>
                        ...
                        {statsOpen && (
                            <div className="mt-3 pt-3 border-t border-gray-100">
                                {/* make the grid cols dynamic based on the number of columns */}
                                <div className={`grid grid-cols-1 md:grid-cols-${table.owner.id === getUserInfoByKey("id") ? 4 : 3} gap-3`}>
                                    ...
                                    {table.owner.id === getUserInfoByKey("id") && (
                                        <div className="bg-gray-50 rounded-xl p-3">
                                            ...
                                            {/* show here 2 names of the members and view more button */}
                            ...
                            {filters.length === 0 ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-7 gap-2">
                                    ...
                                    <p className="text-sm font-medium text-gray-500">
                                        You have not yet created a filter
                                    </p>
                                ...
                                <thead className="bg-gray-50 border-b border-gray-100">
                                    ...
                                    <tr>
                                        ...
                                        {table.schema.map((field: any) => (
                                            ...
                                            >
                                                <div className={`flex flex-col gap-0.5 ${field.type === "number" ? "items-end" : "items-start"}`}>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <p className="text-sm text-gray-500">
                                            View and manage the members of this table.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div className="pt-1 pb-2 border-b border-gray-100 flex-shrink-0">
                                        <div className="flex items-start justify-between gap-3">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className={`h-6 px-2.5 rounded-full text-[11px] font-medium border flex items-center ${user.role === "Editor"
                                                    ? "bg-orange-50 text-orange-600 border-orange-200"
                                                    : "bg-gray-50 text-gray-500 border-gray-200"
                                                    }`}>
                                                    {user.role}
                                                </span>
                                                <button onClick={() => alert("Remove member")} className="w-7 h-7 cursor-pointer rounded-lg border border-red-100 bg-red-50 text-red-500 hover:bg-red-100 transition-all flex items-center justify-center shrink-0">
                                                    <XIcon className="w-3.5 h-3.5" />
                                                </button>
                                            </div>
                                        </div>
